OC.L10N.register(
    ...
    "The note will be shown on the page which asks the user which login option to pick when SAML is used" : "La note sera affichée sur la page qui demande à l'utilisateur quelle option de connexion à choisir lorsque SAML est utilisé",
    ...
    "Show on 2FA Nextcloud Notification page" : "Afficher sur la page 2FA par notification Nextcloud",
    "The note will be shown on the 2FA Nextcloud Notification page, when asking to confirm the connection on another device" : "La note sera affichée sur la page 2FA de notification Nextcloud, lors de la demande de confirmation de la connexion sur un autre appareil",
    ...
    "The note will be styled with Github Markdown Style." : "La note aura le style du Markdown Github.",
